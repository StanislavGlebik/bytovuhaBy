# Django settings for bytovuhaBy project.
...
SECRET_KEY = '0aiyo+!2-iw%nf*xg9jcp_-4o845spxr3g38kx=nmjohta$p%9'
...
ROOT_URLCONF = 'bytovuhaBy.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bytovuhaBy.wsgi.application'
